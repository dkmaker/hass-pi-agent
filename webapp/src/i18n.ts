...
const COLS: Partial<Record<Lang, Record<string, string>>> = {
  da: { entity: "Entitet", state: "Tilstand", name: "Navn", area: "Område", floor: "Etage", devices: "Enheder", entities: "Entiteter", id: "ID", manufacturer: "Producent", model: "Model", integration: "Integration", mode: "Modus", "last triggered": "Sidst udløst", status: "Status", version: "Version", slug: "Slug", icon: "Ikon", property: "Egenskab", value: "Værdi" },
  no: { entity: "Enhet", state: "Tilstand", name: "Navn", area: "Område", floor: "Etasje", devices: "Enheter", entities: "Entiteter", id: "ID", manufacturer: "Produsent", model: "Modell", integration: "Integrasjon", mode: "Modus", "last triggered": "Sist utløst", status: "Status", version: "Versjon", slug: "Slug", icon: "Ikon", property: "Egenskap", value: "Verdi" },
  sv: { entity: "Entitet", state: "Tillstånd", name: "Namn", area: "Område", floor: "Våning", devices: "Enheter", entities: "Entiteter", id: "ID", manufacturer: "Tillverkare", model: "Modell", integration: "Integration", mode: "Läge", "last triggered": "Senast utlöst", status: "Status", version: "Version", slug: "Slug", icon: "Ikon", property: "Egenskap", value: "Värde" },
  de: { entity: "Entität", state: "Zustand", name: "Name", area: "Bereich", floor: "Etage", devices: "Geräte", entities: "Entitäten", id: "ID", manufacturer: "Hersteller", model: "Modell", integration: "Integration", mode: "Modus", "last triggered": "Zuletzt ausgelöst", status: "Status", version: "Version", slug: "Slug", icon: "Symbol", property: "Eigenschaft", value: "Wert" },
};
